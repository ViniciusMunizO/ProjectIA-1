    ...
    <div className="min-h-svh bg-[var(--bg)]">
      ...
      <main className="mx-auto flex max-w-4xl flex-col gap-8 px-6 py-10 sm:px-10">
        <div className="flex items-center justify-between">
          ...
          <Link to="/produtos" className="text-sm font-medium text-[var(--accent)] underline underline-offset-2">
            Ver listagem
          </Link>
        </div>
        ...
        <ProdutoForm
          onSuccess={() => {
            navigate('/produtos', { state: { successMessage: 'Cadastro concluído.' } });
          }}
        />
      </main>
    </div>
